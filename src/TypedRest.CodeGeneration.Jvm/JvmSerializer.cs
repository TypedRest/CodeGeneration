...
/// </summary>
/// <remarks>
/// Requires the <c>kotlin-serialization</c> Gradle plugin in the consuming project: the <c>@Serializable</c> annotation is meaningless without the compiler plugin that acts on it.
/// </remarks>
