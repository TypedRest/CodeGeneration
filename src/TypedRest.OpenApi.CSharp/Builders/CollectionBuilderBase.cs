...
namespace TypedRest.OpenApi.CSharp.Builders
{
        ...
        where TEndpoint : CollectionEndpoint
    {
        ...
        protected override (IEnumerable<CSharpType> types, IEnumerable<CSharpIdentifier> typeArguments) GetAdditional(string key, TEndpoint endpoint, IGenerator generator)
        {
