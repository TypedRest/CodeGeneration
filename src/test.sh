...
$dotnet "$cli" generate -l java -f UnitTests/sample-v3.yml -o SmokeTest.Jvm/generated/java -s Sample -n net.typedrest.smoketest.interfaces.java --generate-dtos --generate-interfaces
...
$dotnet "$cli" generate -l java -f UnitTests/sample-nested.yml -o SmokeTest.Jvm/generated/java -s NestedSample -n net.typedrest.smoketest.interfaces.nested.java --generate-dtos --generate-interfaces
...
$dotnet "$cli" generate -l kotlin -f UnitTests/sample-v3.yml -o SmokeTest.Jvm/generated/kotlin -s Sample -n net.typedrest.smoketest.interfaces.kotlin --generate-dtos --generate-interfaces
...
$dotnet "$cli" generate -l kotlin -f UnitTests/sample-nested.yml -o SmokeTest.Jvm/generated/kotlin -s NestedSample -n net.typedrest.smoketest.interfaces.nested.kotlin --generate-dtos --generate-interfaces
(
    cd SmokeTest.Jvm
