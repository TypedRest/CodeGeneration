...
public static class OpenApiDocumentExtensions
{
    ...
    public static IEnumerable<IGeneratedFile> GenerateTypedRestJava(this OpenApiDocument doc, JavaGenerationOptions options, IGenerationLog? log = null, PatternRegistry? patterns = null, BuilderRegistry? builders = null)
    {
        ...
        var types = doc.GenerateTypedRestJavaEndpoints(naming, log, patterns, builders, typeNames).ToList();
    ...
    /// </summary>
    public static IEnumerable<IJvmType> GenerateTypedRestJavaEndpoints(this OpenApiDocument doc, INamingStrategy naming, IGenerationLog? log = null, PatternRegistry? patterns = null, BuilderRegistry? builders = null, TypeNameRegistry? typeNames = null)
    {
