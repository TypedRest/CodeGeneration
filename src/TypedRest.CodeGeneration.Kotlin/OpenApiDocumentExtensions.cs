...
public static class OpenApiDocumentExtensions
{
    ...
    public static IEnumerable<IGeneratedFile> GenerateTypedRestKotlin(this OpenApiDocument doc, KotlinGenerationOptions options, IGenerationLog? log = null, PatternRegistry? patterns = null, BuilderRegistry? builders = null)
    {
        ...
        var types = doc.GenerateTypedRestKotlinEndpoints(naming, log, patterns, builders, typeNames).ToList();
    ...
    /// </summary>
    public static IEnumerable<IJvmType> GenerateTypedRestKotlinEndpoints(this OpenApiDocument doc, INamingStrategy naming, IGenerationLog? log = null, PatternRegistry? patterns = null, BuilderRegistry? builders = null, TypeNameRegistry? typeNames = null)
    {
